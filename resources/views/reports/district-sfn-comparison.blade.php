...
@section('title', 'District SFN Comparison')

@section('content')

<div class="page-title-bar">
    <div>
        <h1 class="page-title">District SFN Comparison</h1>
        <p class="page-subtitle">
            Compare SFN district performance by tier, KPI category, inspection count and approval score.
        </p>
    </div>
    ...
    <div class="page-title-actions">
        ...
        <a href="{{ route('reports.district-sfn-victim-tier') }}" class="btn-gov btn-gov-primary">
...
<div class="card-ppmf mb-4">
    ...
    <div class="card-ppmf-body">
        <form method="GET" action="{{ route('reports.district-sfn-comparison') }}">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('reports.district-sfn-comparison') }}" class="btn-gov btn-gov-outline flex-fill">
                ...
                <tbody>
                    @forelse($reportData as $index => $row)
                        @php
                            ...
                            if ($score >= 80) {
                                $badgeClass = 'achieved';
                                $performanceText = 'High Performer';
                            } elseif ($score >= 60) {
                                $badgeClass = 'info';
                                $performanceText = 'Good Performer';
                            } elseif ($score >= 40) {
                                $badgeClass = 'pending';
                                $performanceText = 'Average Performer';
                            } else {
                                $badgeClass = 'critical';
                                $performanceText = 'Low Performer';
                            }
                        @endphp
                        ...
                        <tr>
                            <td colspan="11" class="text-center py-5">
                                <div class="manual-box-ppmf">
                                    <i class="bi bi-columns-gap"></i>
                                    <h5>No SFN Comparison Data Found</h5>
                                    <p>No district SFN comparison report data is available for selected filters.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
