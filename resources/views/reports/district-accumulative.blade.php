...
@section('title', 'District Accumulative Report')

@section('content')

<div class="page-title-bar">
    <div>
        <h1 class="page-title">District Accumulative Report</h1>
        <p class="page-subtitle">
            District-wise accumulated inspection progress, approvals, rejections and overall performance score.
        </p>
    </div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6">
        <div class="stat-card-ppmf">
            ...
            <div>
                ...
                <strong>{{ $summary['approval_rate'] ?? $summary['average_score'] ?? 0 }}%</strong>
            </div>
        </div>
    </div>
...
<div class="card-ppmf mb-4">
    ...
    <div class="card-ppmf-body">
        <form method="GET" action="{{ route('reports.district-accumulative') }}">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('reports.district-accumulative') }}" class="btn-gov btn-gov-outline flex-fill">
                        ...
                        <tr>
                            <td colspan="10" class="text-center py-5">
                                <div class="manual-box-ppmf">
                                    <i class="bi bi-bar-chart-line"></i>
                                    <h5>No Accumulative Data Found</h5>
                                    <p>No district accumulative report data is available for selected filters.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
