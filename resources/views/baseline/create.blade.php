...
<div class="page-title-bar">
    <div>
        <h1 class="page-title">Add Baseline Data</h1>
        <p class="page-subtitle">
            Add district-wise baseline summary for KPI category.
        </p>
    </div>
...
<div class="card-ppmf">
    ...
    <div class="card-ppmf-body">
        <form action="{{ route('baseline.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        value="{{ old('baseline_data.total_assets') }}"
                        class="form-control"
                        min="0"
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        value="{{ old('baseline_data.functional_assets') }}"
                        class="form-control"
                        min="0"
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        value="{{ old('baseline_data.non_functional_assets') }}"
                        class="form-control"
                        min="0"
                ...
                <div class="col-md-6">
                    ...
                    >{{ old('baseline_data.remarks') }}</textarea>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <textarea
                        ...
                        class="form-control"
                        rows="3"
                        placeholder="Example: District Excel Sheet / Department Record"
                    >{{ old('baseline_data.source') }}</textarea>
                </div>
