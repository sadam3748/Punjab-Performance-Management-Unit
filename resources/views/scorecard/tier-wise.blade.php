...
<div class="sc-page-card">
    ...
    <div class="sc-filter-card">
        <form method="GET" action="{{ $tierRoute }}">
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-6 col-xl-3 d-flex gap-2"><button type="submit" class="btn btn-gov btn-gov-primary flex-fill"><i class="bi bi-search"></i> Apply</button><a href="{{ $tierRoute }}?tier=1" class="btn btn-gov btn-gov-outline"><i class="bi bi-x-circle"></i> Reset</a></div>
            </div>
        </form>
    </div>
