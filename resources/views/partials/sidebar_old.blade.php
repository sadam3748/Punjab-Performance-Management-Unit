<aside class="ppmf-sidebar" id="ppmfSidebar">
  ...
  <div class="sidebar-nav-wrap">
    ...
    <div class="nav-item">
      <a href="{{ route('petrol-pump.dashboard') }}" class="nav-link {{ request()->routeIs('petrol-pump.*') ? 'active' : '' }}">
...
<div class="nav-item has-submenu">
  ...
  <div class="collapse submenu {{ request()->routeIs('reports.*') ? 'show' : '' }}" id="reportsSubmenu">
    ...
    <a href="{{ route('reports.category-wise-district-score') }}"
       class="submenu-link {{ request()->routeIs('reports.category-wise-district-score') ? 'active' : '' }}">
      <i class="bi bi-grid-3x3-gap"></i>
      Category wise District Score Report
    </a>

    <a href="{{ route('reports.district-sfn-victim-tier') }}"
       class="submenu-link {{ request()->routeIs('reports.district-sfn-victim-tier') ? 'active' : '' }}">
      <i class="bi bi-layers"></i>
      District Sixty Forty, Negative & Victim Tier wise
    </a>

    <a href="{{ route('reports.district-sfn-comparison') }}"
       class="submenu-link {{ request()->routeIs('reports.district-sfn-comparison') ? 'active' : '' }}">
      <i class="bi bi-arrow-left-right"></i>
      District Sixty Forty & Negative Ratio Comparison
    </a>

    <a href="{{ route('reports.division-score') }}"
       class="submenu-link {{ request()->routeIs('reports.division-score') ? 'active' : '' }}">
      <i class="bi bi-diagram-3"></i>
      Division Score Report
    </a>

    <a href="{{ route('reports.district-comparison') }}"
       class="submenu-link {{ request()->routeIs('reports.district-comparison') ? 'active' : '' }}">
      <i class="bi bi-columns-gap"></i>
      District Comparison Report
    </a>

    <a href="{{ route('reports.district-accumulative') }}"
       class="submenu-link {{ request()->routeIs('reports.district-accumulative') ? 'active' : '' }}">
      <i class="bi bi-plus-square"></i>
      District Accumulative
    </a>

    <a href="{{ route('reports.division-kpi-ranking') }}"
       class="submenu-link {{ request()->routeIs('reports.division-kpi-ranking') ? 'active' : '' }}">
      <i class="bi bi-trophy"></i>
      Division KPI Ranking
    </a>

    <a href="{{ route('reports.district-weekly-kpi-inspection') }}"
       class="submenu-link {{ request()->routeIs('reports.district-weekly-kpi-inspection') ? 'active' : '' }}">
      <i class="bi bi-calendar-week"></i>
      District wise Weekly KPI Inspection
    </a>

    <a href="{{ route('reports.district-week-rank-changelog') }}"
       class="submenu-link {{ request()->routeIs('reports.district-week-rank-changelog') ? 'active' : '' }}">
      <i class="bi bi-clock-history"></i>
      District Week wise Score/Rank Changelog
    </a>
    ...
    {{-- KPI Reports --}}
    <div class="nav-group-label">KPI Reports</div>
    ...
    <div class="nav-item">
      <a href="{{ route('reports.district-kpi-score') }}" class="nav-link {{ request()->routeIs('reports.district-kpi-score') ? 'active' : '' }}">
        <i class="bi bi-speedometer2"></i>
    ...
    {{-- Detailed Reports --}}
    <div class="nav-group-label">Detailed Reports</div>

    <div class="nav-item has-submenu">
      <a href="#detailedReportsSubmenu"
         class="nav-link {{ request()->routeIs('reports.category-wise-district-score') || request()->routeIs('reports.district-sfn-victim-tier') || request()->routeIs('reports.district-sfn-comparison') || request()->routeIs('reports.division-score') || request()->routeIs('reports.district-comparison') || request()->routeIs('reports.district-accumulative') || request()->routeIs('reports.division-kpi-ranking') || request()->routeIs('reports.district-weekly-kpi-inspection') || request()->routeIs('reports.district-week-rank-changelog') ? 'active' : '' }}"
         data-bs-toggle="collapse"
         role="button"
         aria-expanded="{{ request()->routeIs('reports.*') ? 'true' : 'false' }}">
        <i class="bi bi-file-earmark-bar-graph"></i>
      ...
      <div class="collapse submenu {{ request()->routeIs('reports.*') ? 'show' : '' }}" id="detailedReportsSubmenu">
