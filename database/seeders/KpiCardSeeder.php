...
class KpiCardSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $cards = [
            ...
            ['Inspection of Educational Institutions', 'inspection-of-educational-institutions', 'Social Sector', 5, 'weekly'],
            ['Inspection of Health Facilities', 'inspection-of-health-facilities', 'Social Sector', 5, 'weekly'],
