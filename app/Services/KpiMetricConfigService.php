    ...
    public function cardsFor(string $slug): array
    {
        ...
        return match ($slug) {
            ...
            'inspection-of-health-facilities' => [
                ...
                $m('Total Facilities Inspected', 'facility_visits', 'bi-clipboard2-check', 'blue'),
                $m('Total Facilities Not Inspected', 'facilities_not_inspected', 'bi-hourglass-split', 'yellow'),
                $m('DC Visits Completed vs Target', 'dc_visit_completion', 'bi-person-badge', 'blue'),
                $m('AC Visits Completed vs Target', 'ac_visit_completion', 'bi-person-check', 'blue'),
                $m('DC Meeting on Health Council Held', 'health_council_meeting', 'bi-people', 'blue'),
                $m('Issues Found - Cleanliness', 'issues_cleanliness', 'bi-stars', 'yellow'),
                $m('Issues Found - Staff Absence', 'issues_staff_absence', 'bi-person-x', 'red'),
                $m('Issues Found - Medicine Shortage', 'issues_medicine_shortage', 'bi-capsule', 'red'),
                $m('Issues Found - Equipment / Utilities', 'issues_equipment_utilities', 'bi-tools', 'yellow'),
                $m('Inspections Validation Target', 'validation_target', 'bi-bullseye', 'purple'),
                $m('Inspections Validated', 'validations_completed', 'bi-patch-check', 'green'),
                $m('Approved Validations', 'approved_validations', 'bi-check-circle', 'green'),
                $m('Rejected Validations', 'rejected_validations', 'bi-x-circle', 'red'),
            ],
