    ...
    public static function config(string $slug): array
    {
        ...
        $charts = match ($slug) {
            'price-of-roti' => [
                ...
                self::chart('bar', 'Violation Type Breakdown', 'violation_type_breakdown', 'Overpricing, underweight, availability and displayed-price-list findings.'),
            ...
            'price-of-plain-bakery-bread' => [
                self::chart('line', 'Daily Inspections vs Target', 'daily_inspections_trend'),
                self::chart('donut', 'Violation Type Breakdown', 'violation_type_breakdown'),
                self::chart('bar', 'Fine Amount: Imposed vs Deposited', 'fine_recovery'),
                self::chart('bar', 'Tehsil Comparison', 'tehsil_comparison'),
                self::chart('bar', 'District Comparison', 'district_comparison'),
            ],
            'price-control-of-essential-commodities' => [
                self::chart('line', 'Daily Inspections vs Target', 'inspection_activity_trend'),
            ...
            'repair-of-small-roads-in-both-urban-and-rural-areas' => [
                self::chart('bar', 'Weekly Target vs Completed', 'weekly_target_vs_completed'),
                self::chart('bar', 'Work Status Breakdown', 'maintenance_status_breakdown'),
                self::chart('line', 'Length Repaired by Period', 'length_repaired_trend'),
            ],
            'zebra-crossings' => [
                self::chart('line', 'School Inspections vs Weekly Target', 'school_inspections_trend'),
                self::chart('donut', 'Crossing Condition Breakdown', 'crossing_status_breakdown'),
                self::chart('gauge', 'Corrective Action Completion Rate', 'crossing_action_completion'),
            ],
            'dysfunctional-streetlights' => [
                self::chart('line', 'Weekly Inspections vs Target', 'repairs_trend'),
                self::chart('donut', 'Light Status Breakdown', 'light_status_breakdown'),
                self::chart('gauge', 'Repair Rate', 'streetlight_repair_rate'),
                self::chart('bar', 'Tehsil Comparison', 'tehsil_comparison'),
                self::chart('bar', 'District Comparison', 'district_comparison'),
            ],
            'covering-of-manholes' => [
